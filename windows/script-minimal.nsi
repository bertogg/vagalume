...
OutFile "${APP_NAME}-${VERSION}-${PLATFORM}-minimal.exe"
...
section
       ...
       # GTK redirect
       MessageBox MB_YESNO "$(Gtk-init)" /SD IDYES IDNO endGtk
       strCpy $0 "http://gtk-win.sourceforge.net/home/index.php/en/Downloads"
       Call openLinkNewWindow 
       MessageBox MB_OK "$(Gtk-ok)"
