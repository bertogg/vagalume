...
static void
vgl_bookmark_change                     (VglBookmark *bookmark,
                                         const char  *newname,
                                         const char  *newurl)
{
        g_return_if_fail(bookmark != NULL);
...
static int
vgl_bookmark_compare                    (gconstpointer bookmark,
                                         gconstpointer bookmark_id)
{
...
static GList *
vgl_bookmark_mgr_find_bookmark_node     (VglBookmarkMgr *mgr,
                                         int             id)
{
