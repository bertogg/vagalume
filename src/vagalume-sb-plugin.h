...
#define IS_VAGALUME_SB_PLUGIN(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), VAGALUME_SB_PLUGIN_TYPE))
#define IS_VAGALUME_SB_PLUGIN_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass),  VAGALUME_SB_PLUGIN_TYPE))
